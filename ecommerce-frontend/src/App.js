...
const Home = () => (
  <section>
    ...
    <p>Aceasta este aplicația noastră de comerț online, unde poți găsi o varietate de produse de calitate.</p>
  </section>
);
...
const About = () => (
  <section>
    <h2>Despre Noi</h2>
    <p>Suntem o companie care oferă cele mai bune produse și servicii pentru clienții noștri.</p>
  </section>
);
...
const Services = () => (
  <section>
    <h2>Servicii</h2>
    <p>Oferim livrare rapidă, suport clienți dedicat și produse de înaltă calitate.</p>
  </section>
);
...
const Contact = () => (
  <section>
    <h2>Contact</h2>
    <p>Ne poți contacta prin email la <strong>support@store.com</strong> sau telefonic la <strong>+123456789</strong>.</p>
  </section>
);
